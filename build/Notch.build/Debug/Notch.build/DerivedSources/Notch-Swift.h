...
@class NSCoder;
SWIFT_CLASS("_TtC5Notch12ANSITextView")
...
/// The window is intentionally larger than the visible panel by <code>bleed</code>
...
SWIFT_CLASS("_TtC5Notch12DrawerWindow")
@interface DrawerWindow : NSWindow
...
SWIFT_CLASS("_TtC5Notch22DrawerWindowController")
@interface DrawerWindowController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC5Notch15TerminalSession")
...
SWIFT_CLASS("_TtC5Notch13TriggerWindow")
@interface TriggerWindow : NSWindow
- (nonnull instancetype)initWithContentRect:(NSRect)contentRect styleMask:(NSWindowStyleMask)style backing:(NSBackingStoreType)backingStoreType defer:(BOOL)flag SWIFT_UNAVAILABLE;
@end
